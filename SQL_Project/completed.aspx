<%@ Page Language="C#" AutoEventWireup="true" CodeFile="completed.aspx.cs" Inherits="trash" %>
...
<form id="form1" runat="server">
    ...
    <div id="btn_box">
        <div id="backup_btn" class="btn">归 &nbsp 档</div>
        <span id="backup_num" class="num">0</span>
        <div id="delete_btn" class="btn">删 &nbsp 除</div>
        <span id="delete_num" class="num">0</span>
    </div>
    <div id="list_box">
        <div id="title">已完成任务</div>
        <ul id="list_ul">
            <!--
